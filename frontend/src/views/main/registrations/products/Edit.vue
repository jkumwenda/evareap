    ...
    methods: {
        ...
        async getProduct() {
            try {
                ...
                this.productData.manufacturer_id = response.product.manufacturer_id;
                this.productData.country_id = response.product.country_id;
                this.productData.entry_date = response.product.entry_date;
                this.productData.expiry_date = response.product.expiry_date;
